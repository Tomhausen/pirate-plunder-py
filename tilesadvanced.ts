...
namespace tilesAdvanced {
    ...
    export class PathfinderSprite extends Sprite {
        ...
        public followUsingPathfinding(target: Sprite, speed = 100) {
            ...
            this.path = scene.aStar(myStart, target.tilemapLocation());
            this.isFollowing = true;
            scene.followPath(this, this.path, speed);
        ...
        public stopFollowingPath() {
            this.isFollowing = false;
            this.path = [];
            scene.followPath(this, this.path, 0);
        }
    }
